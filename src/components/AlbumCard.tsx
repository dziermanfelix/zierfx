...
const AlbumCard = ({ artist, album, search, filterBy }: AlbumCardProps) => {
  ...
  return (
    <Link
      ...
      className='group block bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-300 hover:-translate-y-1'
    >
      <div className='p-4'>
        {/* Album Cover */}
